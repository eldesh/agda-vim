...
class TestResponse(unittest.TestCase):
    ...
    def test_give_action_response_roundtrip(self):
        ...
        self.assert_response(GiveActionResponse, '(agda2-give-action 0 "c")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 1 "even-s (odd-s h0)")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 2 "[]")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 3 "f x ? map f xs")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 4 "x")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 5 "lookup n σ")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 6 "eval σ e (eval σ e?)")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 7 "lookup x σ")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 8 "eval (cons x σ) e")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 0 \'no-paren)')
        self.assert_response(GiveActionResponse, '(agda2-give-action 0 "λ P z → Σ-i x (z x)")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 1 "RAA (A ∨ ￢ A) (λ z → z (∨-i? (λ z? → z (∨-i? z?))))")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 2 "RAA (A ∨ ￢ A) (λ z → z (∨-i? (λ z? → z (∨-i? z?))))")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 3 "p px")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 0 "b 0")')
        self.assert_response(GiveActionResponse, '(agda2-give-action 0 \'paren)')
        self.assert_response(GiveActionResponse, '(agda2-give-action 1 \'no-paren)')
    ...
    def test_highlight_add_annotations_response_roundtrip(self):
        ...
        self.assert_response(HighlightAddAnnotationsResponse, '''(agda2-highlight-add-annotations 'nil '(1 35 (comment) t) '(36 92 (comment) t) '(93 142 (comment) t) '(143 179 (comment) t) '(181 187 (keyword) t) '(188 189 (record) nil nil ("/agda/test/interaction/Issue1790.agda" . 188)) '(190 191 (symbol) t) '(191 192 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 191)) '(193 194 (symbol) t) '(195 198 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)) '(198 199 (symbol) t) '(200 201 (symbol) t) '(201 202 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 201)) '(203 204 (symbol) t) '(205 206 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 191)) '(207 208 (symbol) t) '(209 212 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)) '(212 213 (symbol) t) '(214 215 (symbol) t) '(216 219 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)) '(220 225 (keyword) t) '(228 233 (keyword) t) '(238 241 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 238)) '(242 243 (symbol) t) '(244 245 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 191)) '(250 253 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 250)) '(254 255 (symbol) t) '(256 257 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 201)) '(258 261 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 238)) '(263 310 (comment) t) '(312 347 (comment) t) '(349 355 (keyword) t) '(358 364 (keyword) t) '(365 376 (record) nil nil ("/agda/test/interaction/Issue1790.agda" . 365)) '(377 378 (symbol) t) '(379 383 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)) '(384 389 (keyword) t) '(394 405 (keyword) t) '(406 417 (inductiveconstructor) nil nil ("/agda/test/interaction/Issue1790.agda" . 406)) '(422 427 (keyword) t) '(429 436 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 429)) '(439 440 (symbol) t) '(442 445 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)) '(457 465 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 457)) '(467 468 (symbol) t) '(470 471 (symbol) t) '(471 472 (bound) nil nil ("/agda/test/interaction/Issue1790.agda" . 471)) '(473 474 (symbol) t) '(475 482 (field) nil nil ("/agda/test/interaction/Issue1790.agda" . 429)) '(482 483 (symbol) t) '(484 485 (symbol) t) '(486 489 (primitive) nil nil ("/share/lib/prim/Agda/Primitive.agda" . 388)))''')
